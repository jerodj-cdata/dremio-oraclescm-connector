...
@SourceType(value = "OracleSCMARP", label = "OracleSCM",uiConfig = "oraclescm-layout.json")
public class OracleSCMConf extends AbstractArpConf<OracleSCMConf> {
  private static final String ARP_FILENAME = "arp/implementation/oraclescm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.oraclescm.OracleSCMDriver";
